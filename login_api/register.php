...
if ($_SERVER['REQUEST_METHOD'] == 'POST') :
    ...
    $username = mysqli_real_escape_string($connection, htmlspecialchars(trim($data->username)));
    ...
    $sql = "INSERT INTO `user_accounts`(`username`,`email`,`password`) VALUES('$username','$email','$hash_password')";
    $query = mysqli_query($connection, $sql);
